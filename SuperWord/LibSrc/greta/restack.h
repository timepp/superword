...
template< bool f > struct greta_static_assert;
template<>         struct greta_static_assert<true> { greta_static_assert() {} };
...
public:
    ...
    ~hetero_stack() // throw()
    {
        ...
        detail::greta_static_assert< detail::is_power_of_two<AlignmentT>::value > const align_test;
    ...
    inline void push( T const & t ) // throw(std::bad_alloc,...)
    {
        ...
        detail::greta_static_assert<( AlignmentT >= detail::alignof<T>::value )> const align_test;
    ...
    {
        detail::greta_static_assert< RuntimeTypeCheckT > const type_check;
